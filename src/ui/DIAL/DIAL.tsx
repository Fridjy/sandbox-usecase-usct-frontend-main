  ...
  return (
    <Box position="absolute" bottom="0.5rem" left="0.5rem">
      ...
      >
        ...
        <Image
          src="/images/CARE-exchange-logo.svg"
          alt="CARE Exchange Logo"
                ...
                >
                  <Box>
                    <Text mb="1rem" size="sm" color={colors.secondary[500]}>
                      CARE promotes a Whole-of-Government approach
                      ...
                      <AccordionItem>
                        ...
                        <AccordionPanel>
                          ...
                          <Text size="sm">
                            ...
                            <Link
                              isExternal
                              href="https://CARE.gitbook.io/use-cases/"
                            >
                              CARE Specifications
                            </Link>.
                          </Text>
